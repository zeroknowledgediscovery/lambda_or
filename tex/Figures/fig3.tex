...
\begin{tikzpicture}[font=\bfseries\sffamily\fontsize{10}{10}\selectfont]
  ...
  \node[anchor=north west] (A) at (0,0.0)        {\includegraphics{Figures/External/ADRDpanelA.pdf}};
  \node[anchor=north west] (B) at (A.north east)    {\includegraphics{Figures/External/ADRDpanelB.pdf}};
  \node[anchor=north west] (C)  at (B.north east)    {\includegraphics{Figures/External/ADRDpanelC.pdf}};
