...
\centering 
 ...
 %\tikzXtrue
  ...
  \else
  \includegraphics[width=.9\textwidth]{figsim}
  \fi
...
\centering 
 ...
 % \tikzXtrue
  ...
  \begin{tikzpicture}[font=\bf\sffamily\fontsize{10}{10}\selectfont]
    ...
    \node[anchor=north west] (B) at ([yshift=.15in]A.south west) {\includegraphics[width=\WDT]{figcompsemilogASD}};
    \node[anchor=north west] (C) at ([yshift=.15in]B.south west) {\includegraphics[width=\WDT]{figcompsemilogADRD}};
  \end{tikzpicture}
  \else
\hspace{-10pt}\includegraphics[width=.9\textwidth]{figvolcano}
  \fi
